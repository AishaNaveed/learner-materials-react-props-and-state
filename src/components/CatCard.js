const CatCard = () => {
    ...
    return (
        <>
            {catObj.map((cards) => (
                    <div className="card">
                        <h3 className="card__text card__header">{cards.name}</h3>
                        <img className="card__image" src={cards.photo} alt={cards.alt}></img>
                        <p className="card__text">Species: {cards.species}</p>
                        <p className="card__text">Favourite Food(s): {cards.favFoods}</p>
                        <p className="card__text">Birth Year: {cards.birthYear}</p>
                    </div>
                ))}
        </>
    )
